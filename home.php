...
<!-- Section 1: Uses of the Website -->
<div class="container" style="border-radius:15px">
  <div class="extra-section-container">
    <img src="assets/images/uses.png" alt="Uses of Subscription Manager" width="100%">
    
  </div>
</div>

<!-- Section 2: Ways to Utilize -->
<div class="container" style="margin-top: 30px;border-radius:15px">
  <div class="extra-section-container">
      <img src="assets/images/utilize.png" alt="Utilize Subscription Manager" width="100%" >
  </div>
</div>
